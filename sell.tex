...
In this paper, we will use subexponentials to model the notion of {\em costs}. We will start by considering the particular case where labels will be elements of $\real^+$ (non-negative real numbers), the set of non-negative real numbers. Formally, we substitute in $\aILL$
%our language 
